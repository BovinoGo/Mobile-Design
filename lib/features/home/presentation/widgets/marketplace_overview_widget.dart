...
class MarketplaceOverviewWidget extends StatefulWidget {
  ...
  const MarketplaceOverviewWidget({super.key, this.onNavigateToTab});
...
class _MarketplaceOverviewWidgetState
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      const Text('Mercado Bovino',
                          style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Colors.white)),
                      Text(
                        _loading ? 'Cargando...' : '${_market.length} publicaciones disponibles',
  ...
  Widget _buildBody() {
    ...
    if (active.isEmpty) {
      return Text('No tienes publicaciones activas actualmente.',
